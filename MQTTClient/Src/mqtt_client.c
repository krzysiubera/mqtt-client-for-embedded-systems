...
uint8_t encode_remaining_len(uint8_t* buf, uint32_t remaining_len)
{
...
static void send_fixed_header(struct tcp_connection_raw_t* tcp_connection_raw, uint8_t ctrl_field, uint32_t remaining_len)
{
